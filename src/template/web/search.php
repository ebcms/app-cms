        ...
        <div class="my-4">
            <form method="GET">
                <div class="input-group mb-3">
                    <input type="search" name="q" value="{:$input->get('q')}" class="form-control" style="max-width: 250px;" placeholder="请输入关键词，最少2个字符！" aria-label="请输入关键词，最少2个字符！" aria-describedby="button-addon2">
